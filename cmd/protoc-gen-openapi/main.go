...
func main() {
	conf := generator.Configuration{
		...
		Default200Response: flags.Bool("default_200_response", true, `add 200 response. If "true", automatically adds a 200 response to operations. Useful if you want to have custom status code for your endpoints.`),
